...
public class JdbcCompanyDaoImpl implements CompanyDao {
    ...
    private static final String SELECT_BY_NAME = "SELECT * FROM companies WHERE name=?";
    ...
    private static final String INSERT_AUTO_ID = "INSERT INTO companies (name) VALUES (?)";
    private static final String UPDATE_BY_ID = "UPDATE companies SET name=? WHERE id=?";
