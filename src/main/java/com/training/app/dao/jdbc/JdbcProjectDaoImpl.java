...
public class JdbcProjectDaoImpl implements ProjectDao {
    ...
    private static final String INSERT_AUTO_ID = "INSERT INTO projects (name, cost) VALUES (?,?)";
    private static final String UPDATE_BY_ID = "UPDATE projects SET name=?, cost=? WHERE id=?";
