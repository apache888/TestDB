...
public class JdbcCustomerDaoImpl implements CustomerDao {
    ...
    private static final String INSERT_AUTO_ID = "INSERT INTO customers (name) VALUES (?)";
    private static final String UPDATE_BY_ID = "UPDATE customers SET name=? WHERE id=?";
